...
/*
detect_type permet de definir lee type de chaque "mot" de la commande
*/
...
/*
Le lexer sert a determiner le type de chaque "mot" dans la commande tape par l'utilisateur
*/
